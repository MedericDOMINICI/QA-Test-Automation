...
import java.net.URL;
public class FindOuluHelsinkitirpTest {
  ...
  public void findOuluHelsinkitirp() {
    ...
    driver.findElement(By.id("station-search")).click();
    ...
    driver.findElement(By.id("station-search")).click();
    driver.findElement(By.id("station-search")).sendKeys("helsinki");
    driver.findElement(By.id("stationPickerOption_0")).click();
